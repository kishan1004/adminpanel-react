...
const Dashboard = () => {
  ...
  // const barChartData = {
  //   labels: stats.timeLabels, // Time labels
  //   datasets: [
  //     {
  //       label: "Total Orders",
  //       data: stats.ordersOverTime,
  //       backgroundColor: "rgba(3, 52, 110, 0.7)", // Rich deep blue
  //       borderColor: "#03346E", // Medium blue for borders
  //       borderWidth: 3, // Slightly thicker borders for emphasis
  //       barThickness: 15, // Thicker bars for a more prominent look
  //     },
  //     {
  //       label: "Completed Orders",
  //       data: stats.completedOrdersOverTime,
  //       backgroundColor: "rgba(110, 172, 218, 0.8)", // Soft light blue
  //       borderColor: "#6EACDA", // Matching soft blue border
  //       borderWidth: 3,
  //       barThickness: 15,
  //     },
  //     {
  ...
  //       data: stats.pendingOrdersOverTime,
  //       backgroundColor: "rgba(2, 21, 38, 0.7)", // Deep, rich dark blue
  //       borderColor: "#021526", // Dark blue for borders
  //       borderWidth: 3,
  //       barThickness: 15,
  //     },
  //     {
  //       label: "Canceled Orders",
  //       data: stats.canceledOrdersOverTime || [], // Data for canceled orders
  //       backgroundColor: "rgba(255, 99, 132, 0.7)", // Bold soft red for canceled
  //       borderColor: "#FF6384", // Red border color
  //       borderWidth: 3,
  //       barThickness: 15,
  //     },
  //     {
  //       label: "Returns",
  //       data: stats.returnsOverTime || [], // Data for returns
  //       backgroundColor: "rgba(75, 192, 192, 0.7)", // Teal for returns
  ...
  //       },
  //       grid: {
  //         color: "#E2E2B6", // Light grid lines for subtle contrast
  //         borderColor: "#E2E2B6", // Border color for x-axis grid
  //       },
  //       ticks: {
  //         color: "#6EACDA", // Soft light blue ticks
  //       },
  //     },
  //     y: {
  //       title: {
  ...
  //       grid: {
  //         color: "#E2E2B6", // Light grid lines for subtle contrast
  //         borderColor: "#E2E2B6", // Border color for y-axis grid
  //       },
  //       ticks: {
  //         color: "#6EACDA", // Soft light blue ticks
  //         callback: function (value) {
  ...
  //       radius: 6,
  //       hoverRadius: 8,
  //       backgroundColor: "#6EACDA", // Light blue for points
  //       borderWidth: 2,
  //       borderColor: "#03346E", // Blue border for points
  //     },
  //     bar: {
  //       borderRadius: 8, // Rounded corners for a smooth aesthetic
  //       borderColor: "#03346E", // Border color for bars
  //       borderWidth: 2, // Slightly thinner border for a cleaner look
  //     },
  //   },
  //   interaction: {
  //     mode: "index", // Show interaction based on the x-axis index
  //     intersect: false, // Doesn't require bars to intersect
  //   },
  //   stacked: false, // Disabling stacking to show individual bars
  // };
